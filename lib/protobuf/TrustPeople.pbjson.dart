...
const User$json = const {
  ...
  '2': const [
    ...
    const {'1': 'image', '3': 3, '4': 1, '5': 11, '6': '.route.Photo', '10': 'image'},
  ],
};

/// Descriptor for `User`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userDescriptor = $convert.base64Decode('CgRVc2VyEhIKBG5hbWUYASABKAlSBG5hbWUSHgoKcmVzdHJpY3RlZBgCIAEoCFIKcmVzdHJpY3RlZBIiCgVpbWFnZRgDIAEoCzIMLnJvdXRlLlBob3RvUgVpbWFnZQ==');
...
final $typed_data.Uint8List responseDescriptor = $convert.base64Decode('CghSZXNwb25zZRIWCgZzdGF0dXMYASABKAVSBnN0YXR1cw==');
